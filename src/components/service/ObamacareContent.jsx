...
// Chrome-free content body for the Obamacare service page. Rendered as a STATIC
// Astro island (no client directive → zero JS). The page chrome (ContactBar,
// Footer, the state map, and the quote modal) is composed by the .astro page.
// The CTA button uses data-open-quote; an inline script on the page dispatches
// the mlc:open-quote event that QuoteModalLauncher listens for.
export default function ObamacareContent({ lang = "en" }) {
