...
// Chrome-free content body for the Medicare Advantage service page. Rendered as a
// hydrated island (client:visible) because it contains the interactive MedicareFAQ.
export default function MedicareAdvantageContent({ lang = "en" }) {
